...
export default function AllCoursesClientPage({ initialCourses }: ClientPageProps) {
  ...
  const hasActiveFilters =
    searchQuery !== "" ||
    (filteredQuery.category !== "" && filteredQuery.category !== "all") ||
    (filteredQuery.level !== "" && filteredQuery.level !== "all") ||
    (filteredQuery.language !== "" && filteredQuery.language !== "all") ||
    (filteredQuery.rating !== "" && filteredQuery.rating !== "all") ||
          ...
          <main className='flex-1 min-w-0'>
            ...
            <div className='p-4'>
              <CourseGrid
                ...
                isLoading={false} // Data is already present from server
