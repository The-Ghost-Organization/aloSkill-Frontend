...
import { BookOpen, Heart, ShoppingCart, Truck, X } from "lucide-react";
        ...
        >
          ...
          >
              ...
              >
                <div className='flex items-center gap-2.5'>
                  <div className='flex items-center gap-2'>
                    ...
                    <div>
                      <span className='block font-semibold text-xs text-gray-800'>eBook Only</span>
                      <span className='block text-xs text-orange'>20 tk</span>
                      <span className='block text-[9px] text-gray-400'>Instant Access</span>
                    </div>
                  </div>
                </div>
              </div> */}
            ...
            <button
              ...
              className='w-full bg-amber-500 hover:bg-amber-600 text-white font-bold py-2.5 px-4 rounded shadow-sm transition-colors text-xs cursor-pointer'
            >
              Add to Cart
            </button>
          </div>
