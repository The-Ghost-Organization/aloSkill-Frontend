...
//       <span className='text-[#4a5568] text-sm'>({reviewCount.toLocaleString()} reviews)</span>
//     </div>
//   );
// }
...
//                 <span className='text-3xl font-black text-[#ede8dd]'>${book.price.toFixed(2)}</span>
//                 {book.originalPrice && (
//                   <>
...
//                   icon={Users}
//                   label='Reviews'
//                   value={`${(book.reviewCount / 1000).toFixed(1)}k`}
//                 />
//               </div>
...
//                   </h2>
//                 </div>
//                 <p className='text-[#9aa0b0] leading-relaxed text-sm'>{book.longDescription}</p>
//               </div>
...
//                   </div>
//                 </div>
//                 <p className='text-sm text-[#6b7588] leading-relaxed'>{book.authorBio}</p>
//               </div>
