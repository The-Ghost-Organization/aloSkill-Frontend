      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
          ...
          <div className='order-2 lg:order-1'>
            <div className='relative bg-white rounded-2xl shadow-2xl p-8 md:p-12 border-4 border-gray-100 hover:border-(--color-orange)/20 transition-all duration-300'>
          ...
          <div className='order-1 lg:order-2 space-y-6'>
            ...
            <div className='flex flex-col sm:flex-row gap-4'>
              <button className='px-6 py-3 bg-(--color-orange) text-white rounded-full hover:bg-orange-dark transition-all duration-300 shadow-lg font-semibold'>
                Take a Test
              </button>
              <button className='px-6 py-3 bg-white text-gray-900 border-2 border-gray-300 rounded-full hover:border-(--color-orange) transition-all duration-300 font-semibold'>
                Join a Competition
              </button>
            </div>
            {/* Features */}
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4'>
              <div className='flex items-start gap-3 p-4 bg-gray-50 rounded-xl hover:bg-(--color-orange)/5 transition-colors'>
                <div className='w-10 h-10 bg-(--color-orange)/10 rounded-full flex items-center justify-center shrink-0'>
                  <Award className='w-5 h-5 text-(--color-orange)' />
                </div>
                <div>
              ...
              <div className='flex items-start gap-3 p-4 bg-gray-50 rounded-xl hover:bg-(--color-orange)/5 transition-colors'>
                <div className='w-10 h-10 bg-(--color-orange)/10 rounded-full flex items-center justify-center shrink-0'>
                  <Trophy className='w-5 h-5 text-(--color-orange)' />
                </div>
                <div>
