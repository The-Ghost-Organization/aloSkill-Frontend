...
function Badge({
  ...
  const styles: Record<string, React.CSSProperties> = {
    ...
    gray: {
      background: "rgba(122,156,196,0.08)",
      border: "1px solid rgba(122,156,196,0.15)",
      color: "#7a9cc4",
    },
  };
  return (
    ...
    >
      ...
      {item.priority === "High" && (
        <div
          ...
          style={{ background: "#ff4757", boxShadow: "0 0 8px rgba(255,71,87,0.5)" }}
        />
      )}
      <div
  ...
  return (
    <div className='animate-page-enter'>
      <div className='flex justify-between items-start mb-6 flex-wrap gap-3'>
        <div>
          <h1
            className='text-[22px] font-extrabold text-slate-100'
        ...
        >
          <div
            ...
            style={{ background: "#ff4757", boxShadow: "0 0 6px #ff4757" }}
          />
